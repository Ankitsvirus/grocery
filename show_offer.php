...
<?php
				...
				$q="select * from product where discount>=20";
...
<div class="main" id="">
<center><img src="img/barrackpore2.png" style="position:relative;overflow: none;background-color:;"></center>
 <ul>
  <li><a class="active" href="home.php">Select Product Type</a></li>
					...
					?>
						<div class="col-md-4">
							<div class="panel panel-info">
								...
								<div class="panel-body">
									<a href="viewdetails.php?view_id=<?php echo $row['pid'];?>" class="viewdetails">
									<img src="img/sale.png" ><img src="<?php echo 'admin/img/'.$row['image'] ?>" height=160 width=130 ></a>
								</div>
								<div class="panel-heading"><s><?php echo "<i class='fa fa-inr'></i>".$row['price'];?></s><?php echo " <i class='fa fa-inr'></i>".$row['net_price'];?>
