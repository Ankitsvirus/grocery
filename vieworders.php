...
<?php
	...
	$q="select uname,order_id,order_time,status from order_user where status='pending' order by order_time";
...
<body>
	...
	<center><h1>Pending Orders are</h1></center>
	<a href="show_confirm_orders.php" class="a">Click here to View Confirm Orders</a>
