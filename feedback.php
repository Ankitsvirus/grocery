...
<?php
	...
	$q="select * from feedback order by time";
...
<body>
	...
	<center><table border=1 cellspacing=0 width=90% cellpadding=2 >
		...
		<?php  
			...
			<td><a href="feedback_details.php?fid=<?php echo $fid;?>" class="a" >View</a></td>
			<td><a href="delect_feedback.php?fid=<?php echo $fid;?>" class="a" >Delete</a></td>
			</tr>
			<?php	
			}
