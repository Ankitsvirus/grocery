...
?>
<?php if(isset($_GET['action_id'])){
				$action_id=$_GET['action_id'];
				
				$con=mysqli_connect('localhost','root');
				mysqli_select_db($con,'grocery');
				$q="select * from product where category like '$action_id%'";
...
<div class="navbar">
  <a href="#home" style="font-size:1.5em; background-color: #4CAF50;" id="myDIV2">Amart Grocery Shop</a>
...
<div class="main" id="">
<center><img src="img/amart.png" style="position:relative;overflow: none;background-color:;"></center>
 <ul>
					...
					?>
						<div class="col-md-4">
							<div class="panel panel-info">
								...
								<div class="panel-heading"><?php echo "<i class='fa fa-inr'></i>" .$row['net_price'];?>
